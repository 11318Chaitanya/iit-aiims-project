<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="card-text" viewBox="0 0 16 16">
        <path fill-rule="evenodd"
...
<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; height:100vh;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
        <span class="fs-4">HealthCarePro</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto" id="navList">
        ...
        <li>
            <a href="/project/healthcarepro/main/addpatient.php" class="nav-link link-dark">
        ...
        <li>
            <a href="/project/healthcarepro/main/requestportal" class="nav-link link-dark">
                <svg class="bi me-2" width="16" height="16">
